//go:generate go run ../encodegen.go -s=FixedLength,String,Pointer,Map,Slice,MapSlice,PointerMap,FixedLengths,Unnamed,StrAlias,IntAlias,StrsAlias,PintsAlias,IntsAlias,TestStructAlias,TestStructs,PtestStructs,StrTestStruct,StrTestStructAlias,Alias,OtherPackage -f=./example.go
package example
